...
class FPDMissionEditorCommands : public TCommands<FPDMissionEditorCommands>
{
public:

	FPDMissionEditorCommands()
		: TCommands<FPDMissionEditorCommands>(TEXT("PDMissionEditor"), NSLOCTEXT("Contexts", "PDMissionEditor", "PDMissionEditor Plugin"), NAME_None, FPDMissionEditorStyle::GetStyleSetName())
	{
	}
