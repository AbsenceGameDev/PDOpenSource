...
class PDMISSIONEDITOR_API UPDMissionGraphSchema : public UEdGraphSchema
{
	...
	virtual bool TryCreateConnection(UEdGraphPin* FromPin, UEdGraphPin* ToPin) const override;
...
public:
	...
	virtual void ResetPinToAutogeneratedDefaultValue(UEdGraphPin* Pin, bool bCallModifyCallbacks) const override;
...
protected:
	...
	static void GetPinDefaultValuesFromString(const FEdGraphPinType& PinType, UObject* OwningObject, const FString& NewDefaultValue,
	                                          FString& UseDefaultValue, TObjectPtr<UObject>& UseDefaultObject, FText& UseDefaultText,
